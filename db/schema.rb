...
ActiveRecord::Schema.define(version: 2019_12_06_024839) do
  ...
  add_foreign_key "publicacoes", "areas"
  add_foreign_key "publicacoes", "areas", name: "area_id"
  add_foreign_key "publicacoes", "instituicoes", column: "instituicao_id"
  add_foreign_key "publicacoes", "instituicoes", column: "instituicao_id", name: "instituicao_id"
end
